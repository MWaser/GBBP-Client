module.exports = {
    localMode: true,                                                       // true mocks log-in since can't accept OAuth callback to localhost
    apiUrl: "http://localhost:1340",                                        // http://localhost:1340 or https://gbbp-api.azurewebsites.net
